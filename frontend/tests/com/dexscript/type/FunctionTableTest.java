...
public class FunctionTableTest {
    ...
    public void match_one() {
        ...
        FunctionType stringFunc = new FunctionType("Hello", new ArrayList<>() {{
            add(BuiltinTypes.STRING);
        }}, BuiltinTypes.VOID);
        functionTable.define(stringFunc);
        FunctionType int64Func = new FunctionType("Hello", new ArrayList<>() {{
            add(BuiltinTypes.INT64);
        }}, BuiltinTypes.VOID);
        functionTable.define(int64Func);
        List<FunctionType> resolved = functionTable.resolve("Hello", new ArrayList<>() {{
            add(BuiltinTypes.STRING);
        }});
    ...
    public void match_two() {
        ...
        functionTable.define(stringFunc);
        FunctionType aFunc = new FunctionType("Hello", new ArrayList<>() {{
