...
public class DexReplyStatementImpl extends DexStatementImpl implements DexReplyStatement {

  public DexReplyStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getReply() {
    return notNullChild(findChildByType(REPLY));
  }
