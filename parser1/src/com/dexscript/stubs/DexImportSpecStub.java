...
public class DexImportSpecStub extends DexNamedStub<DexImportSpec> {
  @Nullable
  ...
  public DexImportSpecStub(StubElement parent, IStubElementType elementType, @Nullable String alias, @NotNull String path, boolean isDot) {
